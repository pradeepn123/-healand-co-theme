    ...
    var an = function(e) {
        ...
        vn = function(e) {
            ...
            function n() {
                ...
                })), e._template = e.querySelector("template"), e.element = pe(e._template), e.buttonSelector = '[data-sidebar-button][data-sidebar-id="'.concat(e.id, '"]'), e.withOpenOnInit && e.open(), e.styles = getComputedStyle(E(e)), e
            }
            return p(n, [{
                key: "connectedCallback",
                value: function() {
